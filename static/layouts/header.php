                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo $TO_ROOT ?>vulnerabilities/local_file_inclusion">Local File Inclusion</a></li>
                            <!-- Remote File Inclusion -->
                            <li><a class="dropdown-item" href="<?php echo $TO_ROOT ?>vulnerabilities/remote_file_inclusion">Remote File Inclusion</a></li>
                            <!-- Weak Session IDs -->
