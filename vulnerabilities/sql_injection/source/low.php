...
try {
    ...
    * User able to view all of user data with input that replace within $userid for example if user submit %' or '0'='0 in textbox it will make statement to 
    * SELECT user_id, first_name, last_name FROM users WHERE user_id = '%' or '0'='0'
    * which query everything because condition is always true
    */
